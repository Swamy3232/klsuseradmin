      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div>
            ...
            <p className="text-sm text-blue-100">Showroom: 10 AM – 8 PM</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="text-blue-100">📍 Beside Old Sangeetha Mobiles, Chintamani</li>
            </ul>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-blue-600">
          <p className="text-center text-xs sm:text-sm text-blue-50 px-2">
